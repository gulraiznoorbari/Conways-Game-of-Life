...
ImVec4 toImVec4(const sf::Color& color) {
    return ImVec4(
        color.r / 255.f,
        color.g / 255.f,
        color.b / 255.f,
...
bool ImageButton(const sf::Texture& texture, const sf::Vector2f& size, const int framePadding,
    ...
    return ImGui::ImageButton(texture, ImVec2(size.x, size.y), framePadding, toImVec4(bgColor), toImVec4(tintColor));
}
...
bool ImageButton(const sf::Sprite& sprite, const sf::Vector2f& size, const int framePadding,
    ...
    ImTextureID textureID = convertGLTextureHandleToImTextureID(texture.getNativeHandle());
    return ImGui::ImageButton(sprite, ImVec2(size.x, size.y), framePadding, toImVec4(bgColor), toImVec4(tintColor));
}
